...
<html class="loginHtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link rel="stylesheet" href="{{url('')}}/blogadminback/layui.css" media="all">
        <link rel="stylesheet" href="{{url('')}}/blogadminback/public.css" media="all">
        <link id="layuicss-layer" rel="stylesheet" href="{{url('')}}/blogadminback/layer.css" media="all"></head>
    <body class="loginBody"  style='
        ...
        <form class="layui-form" >
            <div class="login_face"><img src="{{url('')}}/blogadminback/face.jpg" class="userAvatar"></div>
        ...
        <script type="text/javascript" src="{{url('')}}/blogadminback/layui.js"></script>
        <script type="text/javascript" src="{{url('')}}/blogadminback/login.js"></script>
        <script type="text/javascript" src="{{url('')}}/blogadminback/cache.js"></script>
