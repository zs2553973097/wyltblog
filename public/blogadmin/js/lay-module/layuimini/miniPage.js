...
layui.define(["element", "jquery"], function (exports) {
    ...
    var miniPage = {
        ...
        renderHome: function (options) {
            options.homeInfo = options.homeInfo || {};
            options.homeInfo.href = options.homeInfo.href || '';//zwp
            options.renderPageVersion = options.renderPageVersion || false;
        ...
        renderPage: function (href, options) {
            ...
            if(href.indexOf("*reload=true")>0){
                href = href.replace("*reload=true","");
            }
        ...
        renderPageContent: function (href, options) {
            ...
            if (options.renderPageVersion) {
                ...
                href = href.indexOf("?") > -1 ? options.url+href+"/"+options.uid+"/"+options.token + '&v=' + v : options.url+href +"/" +options.uid+"/"+options.token + '/' + v;
                //href = href.indexOf("?") > -1 ? options.url+href+"/"+options.uid+"/"+options.token : options.url+href +"/" +options.uid+"/"+options.token;
            }
            //console.log(href);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //iterateThroughAllKeysAndValues(element.init());
                },
